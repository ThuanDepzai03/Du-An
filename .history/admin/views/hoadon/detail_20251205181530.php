                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input value="<?= $hoaDon['sdt'] ?>" type="text" id="first-name-vertical" class="form-control">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="first-name-vertical">Ngày giờ đặt</label>
                                    <input value="<?= $hoaDon['ngaygiodat'] ?>" type="text" id="first-name-vertical" class="form-control">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="first-name-vertical">Phương thức thanh toán</label>
                                    <input value="<?= $hoaDon['pttt'] == 0 ? "Online" : "Offline" ?>" type="text" id="first-name-vertical" class="form-control">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="first-name-vertical">Trạng thái</label>
                                    <input value="<?= Helper::TRANGTHAITHANHTOAN[$hoaDon['trangthai']] ?>" type="text" id="first-name-vertical" class="form-control">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="first-name-vertical">Tổng tiền</label>
                                    <input value="<?= number_format($hoaDon['tongtien']) ?> VNDa" type="text" id="first-name-vertical" class="form-control">
                                </div>
                            </div>
