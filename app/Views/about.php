    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>
                    Chào mừng bạn đến với <strong>Electro Store</strong> – cửa hàng chuyên cung cấp các
                    sản phẩm điện tử như điện thoại, laptop, phụ kiện công nghệ chính hãng với giá tốt nhất.
                </p>

                <p>
                    Chúng tôi luôn mong muốn đem lại cho khách hàng trải nghiệm mua sắm hiện đại,
            ...
            <!-- RIGHT -->
            <div class="col-md-6">
                <img src="/Public/image/about.jpg" alt="About us" style="border-radius:10px" width="300px">
            </div>
